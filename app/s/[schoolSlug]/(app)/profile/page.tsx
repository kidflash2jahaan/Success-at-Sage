  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      {submissions.length === 0 ? (
        ...
        <MotionStagger className="flex flex-col gap-2" staggerChildren={0.05} delayChildren={0.16}>
          {submissions.map(s => (
            <MotionItem key={s.id} className="card-hover glass rounded-xl px-5 py-4 flex items-start justify-between gap-4 transition-all hover:bg-white/[0.06]">
