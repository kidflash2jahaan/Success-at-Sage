  ...
  return (
    <header className="glass-nav h-14 flex items-center px-4 gap-4 shrink-0 sticky top-0 z-10">
      ...
      <div className="ml-auto flex items-center gap-2">
        <Link
          href="/submit"
          className="hidden sm:flex items-center gap-1.5 text-sm text-violet-400 hover:text-violet-300 font-medium px-3 py-1.5 rounded-lg hover:bg-violet-500/10 transition-colors"
        >
